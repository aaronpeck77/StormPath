 ...
 * Weather weight uses fused corridor forecast stress per route (WeatherKit / Tomorrow.io
 * when route forecast is loaded). Future: tighter coupling with live radar mosaic.
 */
